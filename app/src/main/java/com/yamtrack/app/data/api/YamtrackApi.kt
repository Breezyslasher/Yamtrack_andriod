...
interface YamtrackApi {
    ...
    // change from the web UI, another device, or the cascade in
    // setEpisodeWatched, and a cached response would make those
    // changes look like they reverted on next open.
